...
if (KEY.length !== 32) {
  throw new Error("TOKEN_ENC_KEY_BASE64 must be 32 bytes (base64) for AES-256-GCM");
}
...
// ✅ Added: named export so `import { stableHash } from "./cryptoBox.js"` works
export function stableHash(input) {
  // Deterministic, stable fingerprint hash (not meant for password hashing)
